...
function sumController(request, response){
    let num1 =Number(request.url.split('/')[2]) ;
    let num2 =Number(request.url.split('/')[3]) ;
    let result =num1 +num2
    console.log(result);

    send(response, result.toString(), 'txt');
}

function zarbController(request, response){
    let num1 =Number(request.url.split('/')[2]) ;
    let num2 =Number(request.url.split('/')[3]) ;
    let result =num1 *num2
    console.log(result);
